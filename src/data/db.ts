//definimos el type que tendra este arreglo de objetos y en types en el index.ts se ha definido el type MenuItem
//Y le indicamos que sera un arreglo de objetos de tipo MenuItem
